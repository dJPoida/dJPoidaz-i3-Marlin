...
// DJPOIDAZ_I3: Enable Sanguinololu Examples
 ...
 */
  ...
  // DJPOIDAZ_I3: Reduce thermal protection sensitivity
 ...
 */
  ...
  // DJPOIDAZ_I3: Reduce sensitivity of Bed Thermal Protection
...
// DJPOIDAZ_I3: Hop the z-axis a little higher to resolve endstop latch issues
#define HOMING_BUMP_MM      { 5, 5, 3 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
// DJPOIDAZ_I3: Slow down the second z-homing
...
// @section lcd
  ...
  // DJPOIDAZ_I3: Increase the manual move feedrate
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 6*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  // DJPOIDAZ_I3: Enable the LCD Info Menu
...
// LCD Print Progress options
    ...
    // DJPOIDAZ_I3: Show the remaining time on the LCD
  ...
  // DJPOIDAZ_I3: Scroll Long Filenames
 ...
 */
// DJPOIDAZ_I3: Enable BabyStepping
#define BABYSTEPPING
  ...
  // DJPOIDAZ_I3: Enable DoubleClick for BabyStepping
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    // DJPOIDAZ_I3: Reduce the DoubleClick for BabyStepping interval
